...
import { a as SheetContent, c as SheetTitle, i as Sheet, l as SheetTrigger, s as SheetHeader, t as Route } from "./_category._-_subCategory_-CTJWeR99.js";
import { i as generatedData } from "./constant-BafgMehM.js";
import { n as Container, t as Skeleton } from "./skeleton-Va3ZmfLZ.js";
import { t as Label$1 } from "./label-DyfYK2DG.js";
import { t as ProductCard } from "./product-card-DR3K_pqM.js";
import { i as AccordionTrigger, n as AccordionContent, r as AccordionItem, t as Accordion$1 } from "./accordion-zwFtoIDr.js";
import * as React from "react";
import { useEffect, useState } from "react";
import { Link, getRouteApi, useRouterState } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { CheckIcon, ChevronDownIcon, ChevronLeftIcon, ChevronRightIcon, ChevronUpIcon, Search, SlidersHorizontalIcon } from "lucide-react";
...
//#endregion
//#region src/features/category/components/pagination.tsx
...
//#endregion
//#region src/features/category/components/product-grid.tsx
...
//#endregion
//#region src/features/category/constants/constants.ts
var SORT_OPTIONS = [
	{
...
//#endregion
//#region src/features/category/components/product-sort.tsx
...
//#endregion
//#region src/features/category/components/color-filter.tsx
var categoryRouteApi$2 = getRouteApi("/c/$category/{-$subCategory}");
function ColorFilterSelector() {
	const AVAILABLE_COLORS = generatedData.colors_connection.nodes.map((color) => color.code);
...
//#endregion
//#region src/features/category/components/price-filter.tsx
...
//#endregion
//#region src/features/category/components/size-filter.tsx
var AVAILABLE_SIZES = [
	"XS",
	"S",
	"M",
...
//#endregion
//#region src/features/Products/components/product-filter-test.tsx
var materials = [
	{
		id: "leather",
		label: "Leather",
		...
		children: /* @__PURE__ */ jsxs(Accordion$1, {
			...
			children: [
				/* @__PURE__ */ jsxs(AccordionItem, {
					value: "price",
					children: [/* @__PURE__ */ jsx(AccordionTrigger, { children: "Price" }), /* @__PURE__ */ jsx(AccordionContent, { children: /* @__PURE__ */ jsx(PriceSliderFilter, {}) })]
				}),
				/* @__PURE__ */ jsxs(AccordionItem, {
					value: "color",
					children: [/* @__PURE__ */ jsx(AccordionTrigger, { children: "Color" }), /* @__PURE__ */ jsx(AccordionContent, { children: /* @__PURE__ */ jsx(ColorFilterSelector, {}) })]
				}),
				/* @__PURE__ */ jsxs(AccordionItem, {
					value: "size",
					children: [/* @__PURE__ */ jsx(AccordionTrigger, { children: "Size" }), /* @__PURE__ */ jsx(AccordionContent, { children: /* @__PURE__ */ jsx(SizeFilterSelector, {}) })]
				}),
				/* @__PURE__ */ jsxs(AccordionItem, {
					value: "material",
					children: [/* @__PURE__ */ jsx(AccordionTrigger, { children: "Material" }), /* @__PURE__ */ jsx(AccordionContent, { children: /* @__PURE__ */ jsx("div", {
						className: "space-y-3",
...
//#endregion
//#region src/routes/c/$category.{-$subCategory}.tsx?tsr-split=component
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs(Sheet, { children: [/* @__PURE__ */ jsx(SheetTrigger, {
					...
					children: /* @__PURE__ */ jsxs(Button, {
						variant: "outline",
						className: "w-full",
						children: [/* @__PURE__ */ jsx(SlidersHorizontalIcon, { className: "mr-2 h-4 w-4" }), "Filters"]
					})
				}), /* @__PURE__ */ jsxs(SheetContent, {
					side: "left",
					children: [/* @__PURE__ */ jsx(SheetHeader, { children: /* @__PURE__ */ jsx(SheetTitle, { children: "Filters" }) }), /* @__PURE__ */ jsx("div", {
						className: "mt-6 px-8",

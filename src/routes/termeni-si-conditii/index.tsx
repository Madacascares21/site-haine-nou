...
function RouteComponent() {
  return <div className="p-4 prose">
    ...
    Termenii și condițiile generale prevăzute în continuare se vor aplica tuturor vânzărilor de bunuri de către AUXLOAD STORE  și partenerii săi, prin intermediul magazinului virtual www.auxload-store.ro către Cumpărător și pot fi modificate oricând de către AUXLOAD STORE  fără notificare prealabilă.
    ...
    Vânzător – AUXLOAD STORE , cu denumirea comercială AUXLOAD STORE SRL, având sediul social în Romania, Prahova, Breaza de Jos, Str. Gurga nr. 5, CUI 48293051, nr. de înregistrare la Registrul Comerțului J29/1854/2026.
    ...
    Site – domeniul www.auxload-store.ro și subdomeniile acestuia.
    ...
    Prin lansarea unei Comenzi electronice pe site-ul www.auxload-store.ro, Cumpărătorul este de acord cu forma de comunicare (e-mail, telefon) prin care Vânzatorul își derulează operațiunile. Comanda va fi compusă din următoarele documente:
    ...
    Toate desenele, elementele de grafică și design care apar pe site, numele site-ului precum și însemnele grafice sunt mărci înregistrate în proprietatea AUXLOAD STORE  și nu pot fi preluate, copiate sau folosite, fără acordul scris al proprietarului.

    Toate elementele de conținut cum sunt descrierile, desenele, elementele de grafică și design care apar pe site, incluzând dar nelimitându-se la logo-uri, reprezentări stilizate, simboluri comerciale, imagini statice, imagini dinamice, text și/sau conținut multimedia prezentate pe site, sunt proprietatea exclusivă a AUXLOAD STORE , acestuia fiindu-i rezervate toate drepturile obținute în acest sens în mod direct sau indirect prin licențe de utilizare și/sau publicare.

    Utilizatorului/Cumpărătorului nu îi este permisă copierea, distribuirea, publicarea, transferul către terțe părți, modificarea și/sau altfel alterarea, utilizarea, legarea la, expunerea, includerea oricărui element conținut de mai sus în orice alt context decât cel original intenționat de AUXLOAD STORE , includerea oricărui element de conținut în afara Site-ului, îndepărtarea însemnelor care semnifică dreptul de autor al AUXLOAD STORE  asupra elementelor de conținut precum și participarea la transferul, vânzarea, distribuția unor materiale realizate prin reproducerea, modificarea sau afișarea elementelor de conținut, decât cu acordul scris expres al AUXLOAD STORE .
    ...
    (ii) sunt permise link-urile catre site-ul www.auxload-store.ro, iar specificarea sursei informatiilor se va face dupa fiecare link sau in finalul articolului, dupa cum urmeaza: „Informatii furnizate prin amabilitatea AUXLOAD STORE – link catre continutul site-ului)

    Utilizatorii se obliga sa respecte toate drepturile de autor si toate drepturile conexe acestuia si orice alte drepturi de proprietate intelectuala pe care Administratorul site-ului si partenerii sai le detin asupra/in legatura cu site-ul  www.auxload-store.ro.

    AUXLOAD STORE  isi rezerva dreptul de a actiona in instanta orice persoana si/sau entitate care incalca in orice mod prevederile de mai sus. Cererile de utilizare a continutului site-ului in orice scop altul decat cel personal pot fi facute prin e-mail la adresa mail @ AUXLOAD STORE .ro, cu specificatia „In atentia agenției”.

    Orice persoana care transmite sau publica in orice mod informatii ori materiale catre site isi asuma obligatia de a nu prejudicia in nici un mod drepturile de autor pe care o terta persoana le-ar putea invoca in legatura cu materialele si informatiile transmise in orice mod catre site, iar persoanele care expediaza in orice mod informatii ori materiale inteleg si accepta ca incalcarea in orice mod a acestei obligatii nu poate angaja in niciun mod raspunderea AUXLOAD STORE , ci numai raspunderea persoanelor respective.

    AUXLOAD STORE  poate derula in orice moment campanii publicitare si/sau promotii in orice sectiune din site, fara ca aceasta operatiune sa necesite acordul Utilizatorilor site-ului. Spatiile si dimensiunea campaniilor publicitare si promotiilor nu necesita acordul Utilizatorilor site-ului si pot fi schimbate oricand fara a necesita anuntarea prealabila.

    AUXLOAD STORE  nu isi asuma responsabilitatea pentru prejudiciile sau pierderile rezultate din campaniile publicitare sau promotiile organizate in site, altele decat cele organizate strict pe site.
    ...
    AUXLOAD STORE  nu isi asuma obligatia si nu garanteaza implicit sau expres, pentru continutul site-ului, respectiv pentru continutul oferit de partenerii sai sau de Utilizatorii site-ului. Cu toate acestea, AUXLOAD STORE  va depune toate eforturile rezonabile pentru a asigura acuratetea si maniera profesionista in care vor fi furnizate informatiile pe site, pentru a dobandi si mentine increderea Utilizatorilor in site. In acest sens, AUXLOAD STORE  va incerca sa corecteze in cel mai scurt timp posibil erorile si omisiunile semnalate.
    ...
    Cum utilizeaza AUXLOAD STORE  cookie-urile?
    ...
    – aceste cookies sunt folosite de retelele de socializare (Facebook, Twitter, Google+, YouTube, Instagram, Pinterest, etc) si permit distribuirea continutului de pe www.auxload-store.ro pe respectivele retele. AUXLOAD STORE .ro nu controleaza aceste cookies, deci, pentru mai multe informatii despre cum functioneaza, te rugam sa verifici paginile retelelor de socializare.

    Cum să administrezi & ştergi cookie-uri

    Dacă vrei să impui restricţii, să blochezi sau să ştergi fişiere cookie, poţi s-o faci modificând setările navigatorului tău de web. Utilizarea www.auxload-store.ro fără respingerea cookie-urilor sau a tehnologiilor similare denotă consimţământul vizitatorilor pentru utilizarea de către noi a unor astfel de tehnologii şi pentru prelucrarea informaţiilor.
    ...
    Acceptarea va fi facută atunci când Bunurile sunt conforme cu caracteristicile tehnice menționate în Comandă. În cazul în care Cumpărătorul descoperă că Produsele livrate nu sunt conforme specificațiilor tehnice, atunci Vânzătorul va aduce la conformitate Produsele. De asemenea, pentru produsele vândute și livrate de AUXLOAD STORE , Cumpărătorul beneficiază de returul produselor în 14 zile.
    ...
    In conformitate cu Regulamentul (UE) 2017/679, AUXLOAD STORE  va administra in conditii de siguranta si numai pentru scopurile specificate, datele personale furnizate de Utilizatori. Prin Termeni si Conditii Utilizatorii sunt informati ca datele personale pe care le furnizeaza urmeaza a fi prelucrate in scopul oferirii in conditii optime de catre AUXLOAD STORE  a serviciilor pe internet, a serviciilor de furnizare bunuri si servicii, a serviciilor de reclama, marketing si publicitate si a serviciilor de statistica.

    AUXLOAD STORE  realizează următoarele operaţiuni de prelucrare: colectarea, inregistrarea, organizarea, stocarea, adaptarea, modificarea, extragerea, consultarea, utilizarea si, in unele cazuri, transmiterea catre terti, in baza exclusiva si reglementata a unui contract comercial care asigura securitatea si confidentialitatea datelor, precum si respectarea drepturilor utilizatorului, a datelor personale ale Utilizatorilor site-ului pentru a administra, mentine, imbunatati si obtine informaţii cu privire la serviciile pe care le ofera, precum si pentru a preveni erori si scurgeri de informatii prin reteaua IT proprie, incalcari ale legii sau termenilor contractuali.
    ...
    Pentru exercitarea acestor drepturi, Utilizatorii pot face o cerere in scris in acest sens, pe care o vor trimite prin e-mail la adresa  gd69435@gmail.com cu specificația „Solicitare date cu caracter personal”.
    ...
    persoana vizata și-a dat consimțământul pentru prelucrarea datelor cu caracter personal pentru unul sau mai multe scopuri specifice
    ...
    prelucrarea este necesara în vederea îndeplinirii unei obligații legale care ii revine operatorului.
    prelucrarea este necesara pentru a proteja interesele vitale ale persoanei vizate sau ale altei persoane fizice
    prelucrarea este necesara pentru îndeplinirea unei sarcini care servește unui interes public sau care rezulta în exercitarea autorității publice cu care este investit operatorul.
    ...
    Aveți dreptul de a solicita modificarea modului în care sunt prelucrate automat datele dumneavoastră personale, solicitând verificarea procesului automatizat prin intervenție umană. În acest scop vă rugăm să ne contactați la adresa de email  gd69435@gmail.com.
    ...
    Prezentul contract este supus legii Române. Eventualele litigii apărute între AUXLOAD STORE  și utilizatori/clienți/cumpărători se vor rezolva pe cale amiabilă sau, în cazul în care aceasta nu va fi posibilă, litigiile vor fi soluționate de instanțele judecătorești Române competente.
    ...
    AUXLOAD STORE nu are în desfășurare campanii cu oferte speciale.

  ...
  return (
    <div className="rounded-xl border border-border bg-card p-6 relative overflow-hidden">
          ...
          return (
            <li
              ...
              className={`flex gap-4 transition-all relative ${
                !isAvailable ? "opacity-50 grayscale-[30%]" : ""
              }`}
            >
              {isAnyLoading && (
              ...
              <div className="relative h-20 w-20 shrink-0 overflow-hidden rounded-lg border bg-muted flex items-center justify-center">
                {imageUrl ? (
                  <img
              ...
              <div className="flex min-w-0 flex-1 flex-col">
                ...
                <div className="mt-1 flex items-center gap-2 text-xs text-muted-foreground">
                  ...
                  {variant?.color?.name && (
                    <span className="capitalize">{variant.color.name}</span>
                  )}
      ...
      <div className="flex items-baseline justify-between">
        ...
        <span className="text-xl font-bold">{formatPrice(totalCost)}</span>
      </div>
    </div>
  );
}
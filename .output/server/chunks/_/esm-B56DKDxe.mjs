...
var DiagAPI = (function() {
  ...
  DiagAPI2.instance = function() {
    if (!this._instance) this._instance = new DiagAPI2();
...
var ROOT_CONTEXT = new (/* @__PURE__ */ (function() {
  function BaseContext(parentContext) {
    ...
    self.setValue = function(key, value) {
      var context2 = new BaseContext(self._currentContext);
...
var DiagConsoleLogger = /* @__PURE__ */ (function() {
...
var NoopMetric = /* @__PURE__ */ (function() {
...
var ContextAPI = (function() {
  ...
  ContextAPI2.getInstance = function() {
    if (!this._instance) this._instance = new ContextAPI2();
    return this._instance;
  };
...
var NoopTracer = (function() {
  ...
  NoopTracer2.prototype.startSpan = function(name, options, context2) {
    if (context2 === void 0) context2 = contextApi.active();
...
var propagation = (function() {
  ...
  PropagationAPI.prototype.inject = function(context2, carrier, setter) {
    if (setter === void 0) setter = defaultTextMapSetter;
    return this._getGlobalPropagator().inject(context2, carrier, setter);
  };
  PropagationAPI.prototype.extract = function(context2, carrier, getter) {
...
//# sourceMappingURL=esm-B56DKDxe.mjs.map

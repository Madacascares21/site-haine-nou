...
import { pgTable, timestamp, integer, text, uuid, unique, boolean, index, varchar, numeric, jsonb, serial } from 'drizzle-orm/pg-core';
...
var NodeResponse = /* @__PURE__ */ (() => {
  ...
  class NodeResponse2 {
    ...
    _toNodeResponse() {
      ...
      const headers = [];
      const initHeaders = this.#init?.headers;
      const headerEntries = this.#response?.headers || this.#headers || (initHeaders ? Array.isArray(initHeaders) ? initHeaders : initHeaders?.entries ? initHeaders.entries() : Object.entries(initHeaders).map(([k2, v]) => [k2.toLowerCase(), v]) : void 0);
...
function c$1(e, r, t, n2, a, s, i, u, l, g, S, d) {
  return {
    t: e,
    i: r,
    s: t,
...
async function xn(e, r, t) {
  let n2 = [];
  for (let a = 0, s = t.length; a < s; a++) a in t ? n2[a] = await N$1(e, r, t[a]) : n2[a] = 0;
  return n2;
}
...
async function Dr(e, r, t) {
  ...
  for (let i = 0, u = n2.length; i < u; i++) a.push(y$1(n2[i][0])), s.push(await N$1(e, r, n2[i][1]));
...
async function On(e, r, t, n2) {
  return ke(t, await N$1(e, r, n2.valueOf()));
}
async function wn(e, r, t, n2) {
  return De(t, n2, await N$1(e, r, n2.buffer));
}
async function hn(e, r, t, n2) {
  return Fe(t, n2, await N$1(e, r, n2.buffer));
}
async function zn(e, r, t, n2) {
  return Be(t, n2, await N$1(e, r, n2.buffer));
}
async function _t(e, r, t, n2) {
  let a = Z(n2, e.base.features);
  return Ve(t, n2, a ? await Dr(e, r, a) : o$1);
}
async function _n(e, r, t, n2) {
  let a = Z(n2, e.base.features);
  return Me(t, n2, a ? await Dr(e, r, a) : o$1);
}
async function kn(e, r, t, n2) {
  let a = [], s = [];
  for (let [i, u] of n2.entries()) a.push(await N$1(e, r, i)), s.push(await N$1(e, r, u));
  return or(e.base, t, a, s);
}
async function Dn(e, r, t, n2) {
  let a = [];
  for (let s of n2.keys()) a.push(await N$1(e, r, s));
  return Le(t, a);
}
...
async function Mn(e, r, t, n2) {
  let a = [];
  for (let s = 0, i = n2.v.length; s < i; s++) a[s] = await N$1(e, r, n2.v[s]);
...
async function Ln(e, r, t, n2) {
  ...
  if (a === j) return N$1(e, r, n2.replacement);
  ...
  if (C in n2 || v$1 in n2) return _r(e, r, t, n2, !!a);
  throw new x$1(n2);
}
...
function uo(e, r, t) {
  let n2 = Br(t, st, t.s);
  return Wt(e, r, t, b(e, t.i, new n2(D$1(t.m))));
}
function lo(e, r, t) {
  let n2 = ee(), a = b(e, t.i, n2.p), s = p$1(e, r, t.f);
...
function mo(e, r, t) {
  ...
  if (n2) return de(e, t, t.i, 22), n2.s(p$1(e, r, t.a[1])), o$1;
  throw new V("Promise");
}
function po(e, r, t) {
  let n2 = e.base.refs.get(t.i);
  if (n2) return de(e, t, t.i, 22), n2.f(p$1(e, r, t.a[1])), o$1;
  throw new V("Promise");
}
function go(e, r, t) {
  p$1(e, r, t.a[0]);
...
function bo(e, r, t) {
  let n2 = e.base.refs.get(t.i);
  if (n2) return de(e, t, t.i, 31), n2.next(p$1(e, r, t.f)), o$1;
  throw new V("Stream");
}
function vo(e, r, t) {
  let n2 = e.base.refs.get(t.i);
  if (n2) return de(e, t, t.i, 31), n2.throw(p$1(e, r, t.f)), o$1;
  throw new V("Stream");
}
function Co(e, r, t) {
  let n2 = e.base.refs.get(t.i);
  if (n2) return de(e, t, t.i, 31), n2.return(p$1(e, r, t.f)), o$1;
  throw new V("Stream");
}
function Ao(e, r, t) {
...
function To(e) {
  let r = [], t = e[0];
  for (let n2 = 1, a = e.length, s, i = t; n2 < a; n2++) s = e[n2], s.t === 0 && s.v === i.v ? t = {
    t: 0,
    s: s.s,
    k: o$1,
    v: ye(t)
...
function Fo(e, r) {
  ...
  let n2 = e.vars[t];
  return n2 ?? (n2 = Vr(t), e.vars[t] = n2), n2;
}
function Bo(e) {
  return le + "[" + e + "]";
}
...
function Qt(e, r, t, n2) {
  return t ? F(e.base, t) ? (w$1(e.base, r), Ne(e, r, n2, m$1(e, t.i)), "") : f$1(e, t) : "";
}
function jo(e, r) {
...
function Wo(e, r, t, n2, a) {
  let s = e.base, i = f$1(e, a), u = Number(n2), l = u >= 0 && u.toString() === n2 || Mr(n2);
...
function Go(e, r, t, n2, a) {
  if (typeof n2 == "string") Wo(e, r, t, n2, a);
    ...
    s.stack = i;
    let l = s.assignments;
    s.assignments = t, Ne(e, r.i, f$1(e, n2), u), s.assignments = l;
  }
}
function Ko(e, r, t) {
  let n2 = t.k, a = n2.length;
...
function rn(e, r, t) {
  let n2 = e.base;
  return F(n2, t) ? (w$1(n2, r), Mo(e, r, m$1(e, t.i)), "") : f$1(e, t);
}
function $o(e, r) {
...
function tn(e, r, t, n2, a) {
  ...
  if (F(s, t)) {
    let i = m$1(e, t.i);
    if (w$1(s, r), F(s, n2)) return ge(e, r, i, m$1(e, n2.i)), "";
    if (n2.t !== 4 && n2.i != null && Ur(s, n2.i)) {
      let l = "(" + f$1(e, n2) + ",[" + a + "," + a + "])";
      return ge(e, r, i, m$1(e, n2.i)), Xt(e, r, a), l;
    }
    let u = s.stack;
...
function Xo(e, r) {
  let t = ho, n2 = r.e.k, a = n2.length, s = r.i, i = r.f, u = m$1(e, i.i), l = e.base;
  if (a > 0) {
    let g = r.e.v;
    l.stack.push(s);
...
function ca(e, r) {
  let t = "", n2 = false;
  return r.f.t !== 4 && (w$1(e.base, r.f.i), t = "(" + f$1(e, r.f) + ",", n2 = true), t += ae(e, r.i, "(" + At + ")(" + m$1(e, r.f.i) + ")"), n2 && (t += ")"), t;
}
function fa(e, r) {
...
function Sa(e, r) {
  ...
  let i = ae(e, r.i, "(" + Et + ")(" + m$1(e, n2.i) + "," + m$1(e, t.i) + ")");
  return s ? s + i + ")" : i;
}
function ma(e, r) {
  return q$1(e, r.a[0]) + "(" + f$1(e, r.a[1]) + ")";
...
function pa(e, r) {
  let t = ae(e, r.i, q$1(e, r.f) + "()"), n2 = r.a.length;
  if (n2) {
    let a = f$1(e, r.a[0]);
...
function nn(e, r, t, n2) {
  let a = e.base;
  return F(a, n2) ? (w$1(a, r), Lo(e, r, t, m$1(e, n2.i)), "") : f$1(e, n2);
}
function Na(e, r) {
...
function fr(e, r) {
  ...
  if (n2 == null) return t;
  let a = sn(e.base), s = m$1(e, n2), i = e.state.scopeId, u = i == null ? "" : le, l = a ? "(" + t + "," + a + s + ")" : t;
...
function Zr(e, r, t) {
  let n2 = Object.entries(t), a = [], s = [];
  for (let i = 0, u = n2.length; i < u; i++) a.push(y$1(n2[i][0])), s.push(E$1(e, r, n2[i][1]));
...
function Ta(e, r, t, n2) {
  let a = [], s = [];
  for (let [i, u] of n2.entries()) a.push(E$1(e, r, i)), s.push(E$1(e, r, u));
  return or(e.base, t, a, s);
}
...
function ha(e, r, t) {
  if (this.state.alive) {
    let n2 = W(this, r, t);
    n2 && se(this, c$1(23, e, o$1, o$1, o$1, o$1, o$1, [k(this.base, 2), n2], o$1, o$1, o$1, o$1)), be(this);
  }
}
function za(e, r, t) {
  if (this.state.alive) {
    let n2 = W(this, r, t);
    n2 && se(this, c$1(24, e, o$1, o$1, o$1, o$1, o$1, [k(this.base, 3), n2], o$1, o$1, o$1, o$1));
  }
  be(this);
}
...
function Fa(e, r, t, n2) {
  let a = [];
  for (let s = 0, i = n2.v.length; s < i; s++) a[s] = E$1(e, r, n2.v[s]);
  return Ke(t, a, n2.t, n2.d);
}
...
function Va(e, r, t, n2) {
  ...
  return cn(e, r, t, n2) || Ba(e, r, t, n2, a);
}
function Ma(e, r, t) {
  let n2 = Y$1(e.base, t);
  if (n2.type !== 0) return n2.value;
...
function Pu(e, r = {}) {
  var i;
  let t = A(r.plugins), n2 = r.disabledFeatures || 0, a = (i = e.f) != null ? i : 63;
  return sr(Lt({
    plugins: t,
    markedRefs: e.m,
    features: a & ~n2,
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import('../_/_tanstack-start-manifest_v-QOYywjfX.mjs');
...
var manifest = {
  "2c5a77111882588f192fc21714c67e9ca792182c9b01ab686bf0f8c086526f13": {
    functionName: "mergeCartServerFn_createServerFn_handler",
    importer: () => import('../_/cart.function-B90pClgo.mjs')
  },
  "320b20df46a897fdac7b4c0604c8114f427784a2e4bb7478c59ae0d8a3d9d1b3": {
    functionName: "ensureSession_createServerFn_handler",
    importer: () => import('../_/auth.functions-MIHsi0Ba.mjs')
  },
  "360c5d5d88b79902f98c66b2da2e925061bf87a8dc8e461b85a4b5d269a96b6c": {
    functionName: "batchProductsServerFn_createServerFn_handler",
    importer: () => import('../_/product.function-BCIZ1re2.mjs')
  },
  "71baef3308fabf9f2c8f5a1374bed922483a7042088a9ab3bca2d59a19cce5fe": {
    functionName: "bestPriceServerFunc_createServerFn_handler",
    importer: () => import('../_/product.function-BCIZ1re2.mjs')
  },
  ...
  "8c801c6e7f19e976f6d9810e98c2e7ad8b2015e92eab0286851dc2f4e9da39a9": {
    functionName: "createOrderServerFn_createServerFn_handler",
    importer: () => import('../_/checkout-BuUbZO-8.mjs')
  },
  "8d4e25a98da381fff5f23fd7df60f25789349d7c76730c0fdc8589176baae0b6": {
    functionName: "getCartServerFn_createServerFn_handler",
    importer: () => import('../_/cart.function-B90pClgo.mjs')
  },
  "a31ecafd33dc539afd16b9a1d9afb86aaae0fdeecae0169f9dfde98b1f2409f3": {
    functionName: "upsertCartItemServerFn_createServerFn_handler",
    importer: () => import('../_/cart.function-B90pClgo.mjs')
  },
  "c671e96b1f14cdb8d686a520ba822d1b8a905b8a88e4d5d0dd594c1b18dd85ee": {
    functionName: "getOrderListServerFn_createServerFn_handler",
    importer: () => import('../_/order-DKl7iD4v.mjs')
  },
  "d8547aa630dbccd79f984ada75379e704de686d39b5d49a84e2b5dade2ec0983": {
    functionName: "getProductsServerFunc_createServerFn_handler",
    importer: () => import('../_/product.function-BCIZ1re2.mjs')
  },
  "e5275775162291913974bc24d46af65250942d35e3ea58392f5641ce02a6bd5e": {
    functionName: "clearCartServerFn_createServerFn_handler",
    importer: () => import('../_/cart.function-B90pClgo.mjs')
  },
  "e7c5210c088e840540d2b74578ae3e8758867c0247b7bbf69e2cc141950e85b2": {
    functionName: "getOrderServerFn_createServerFn_handler",
    importer: () => import('../_/order-DKl7iD4v.mjs')
  },
  "f3a5bc0aa1a631ea7d20ff4385c584e39d8c57900fa06e2de997b330a6704432": {
    functionName: "featuredProductsServerFunc_createServerFn_handler",
    importer: () => import('../_/product.function-BCIZ1re2.mjs')
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import('../_/router-DVmJmQLB.mjs').then(function (n) { return n.r; }),
    import('../_/start-CgYQWT56.mjs'),
    import('../_/empty-plugin-adapters-Bti1m3vb.mjs')
  ]);
  return {
    routerEntry,
    startEntry,
...
export { TSS_SERVER_FUNCTION as T, cartItems as a, getServerFnById as b, createServerFn as c, db as d, drizzleSchema as e, entry$1 as f, getRequestHeaders as g, order as o, server as s };
